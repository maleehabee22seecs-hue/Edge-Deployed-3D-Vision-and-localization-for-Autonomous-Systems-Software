...
namespace orb_slam2_ros
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(dynamic_reconfigureConfig &config, const dynamic_reconfigureConfig &max, const dynamic_reconfigureConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const dynamic_reconfigureConfig &config1, const dynamic_reconfigureConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, dynamic_reconfigureConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const dynamic_reconfigureConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, dynamic_reconfigureConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const dynamic_reconfigureConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const dynamic_reconfigureConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, dynamic_reconfigureConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
